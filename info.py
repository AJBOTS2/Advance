...
VERIFY_SHORTLINK_URL = environ.get('VERIFY_SHORTLINK_URL', 'https://Linkspay.in')
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '4eb4c465c67b29ff5ea7478bf729fd67671b05be')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/tokenprocess_video/4')

# If You Fill Second Shortner Then Bot Attach Both First And Second Shortner And Use It For Verify.
VERIFY_SECOND_SHORTNER = bool(environ.get('VERIFY_SECOND_SHORTNER', True))
# if verify second shortner is True then fill below url and api
VERIFY_SND_SHORTLINK_URL = environ.get('VERIFY_SND_SHORTLINK_URL', 'https://Linkspay.in')
VERIFY_SND_SHORTLINK_API = environ.get('VERIFY_SND_SHORTLINK_API', '4eb4c465c67b29ff5ea7478bf729fd67671b05be')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://advance-56iz.onrender.com")
